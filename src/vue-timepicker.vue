    ...
    <div class="dropdown" v-show="showDropdown">
      <div class="select-list">
        <ul class="hours">
          ...
          <li v-for="hr in hours" v-text="hr" :class="{active: hour === hr, inactive: hr < new Date().getHours() && passThruTime < new Date().getTime()}" @click.stop="select('hour', hr)"></li>
        </ul>
        <ul class="minutes">
